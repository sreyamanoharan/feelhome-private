  ...
  return (
   ...
   <ul className="menu menu-horizontal px-3">
     ...
     <li>
         ...
         <a href='/host/hostProps' className="text-black hover:bg-gray-600 hover:text-white text-opacity-60 dark:text-opacity-80  transition-colors duration-300">My Properties</a>
